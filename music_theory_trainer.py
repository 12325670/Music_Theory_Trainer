...
class MusicTheoryTrainer:
    def __init__(self, root):
        ...
        # Owner information
        self.owner = "Subhash & Manikanta"
        
        # Team member details
        self.team_members = [
            {"name": "Manikanta", "id": "12303425"},
            {"name": "Subhash", "id": "12325670"},
        ]
    ...
    def setup_chat_tab(self):
        ...
        title_label = ttk.Label(header_frame, 
                                text=" AI Music Theory Trainer ", 
                                style="Header.TLabel")
        title_label.pack(pady=10)
        
        # Description subtitle
        subtitle = ttk.Label(header_frame, 
                             text="Your personal assistant for learning music theory in Hinglish",
                             style="TLabel")
        ...
        welcome_message = "Welcome to AI Music Theory Trainer! Ask me any question about music theory in Hindi or English. \n\n"
    ...
    def setup_instructions_tab(self):
        ...
        instructions = """Welcome to the AI Music Theory Trainer!

This application helps you learn music theory with responses in Hinglish or English.

📌 HOW TO USE:

1️⃣ Type your question about music theory and press Enter or click Send
   Example: "Raag Bhairav ke baare mein batao" or "Explain major scales"
...
✨ TIPS:
• Ask about any music theory topic - Western or Indian classical
...
Developed by: """ + self.owner
    ...
    def send_question(self):
        ...
        if any(keyword in lower_question for keyword in ["who is your owner", "who made you", "who created you", 
            ...
            owner_response = f"I was developed by {self.owner}. I'm here to help you learn music theory!"
        ...
        # Check for "about" questions to show team details
                                                          ...
                                                          "who made this app", "tell me about","who are you"]):
            team_info = "This app was developed by the following team members that assist to learn music theory in english or Hindi using Gemini API:\n\n"
    ...
    def get_ai_response(self, prompt):
        ...
        try:
            ...
            enhanced_prompt = f"""Please answer the following music theory question. If the question is in Hindi or contains Hindi words, 
